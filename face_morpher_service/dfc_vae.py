...
def encoder(input_imgs, is_train = True, reuse = False):
    ...
    with tf.variable_scope("encoder", reuse = reuse):
        ...
        net_h0 = BatchNormLayer(net_h0, act=lambda x: tf.nn.leaky_relu(x, 0.2),
...
def generator(inputs, is_train = True, reuse = False):
    ...
    with tf.variable_scope("generator", reuse = reuse):
        ...
        net_h0 = BatchNormLayer(net_h0, act=lambda x: tf.nn.leaky_relu(x, 0.2), is_train=is_train,
        ...
        net_h1 = BatchNormLayer(net_h1, act=lambda x: tf.nn.leaky_relu(x, 0.2), is_train=is_train,
        ...
        net_h2 = BatchNormLayer(net_h2, act=lambda x: tf.nn.leaky_relu(x, 0.2), is_train=is_train,
        ...
        net_h3 = BatchNormLayer(net_h3, act=lambda x: tf.nn.leaky_relu(x, 0.2), is_train=is_train,
